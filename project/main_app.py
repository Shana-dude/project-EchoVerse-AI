...
def show_home_dashboard():
    ...
    if st.session_state.get('original_text'):
        ...
        st.info("👋 Welcome! Start by uploading text, pasting content, or generating content from a topic in the Text Input section.")
    ...
    with st.expander("🤖 AI Text Generation from Topics"):
        st.markdown("""
        - **Generate from Topic**: Enter any topic and let AI create content for you
        - **Content Types**: Choose from articles, stories, essays, tutorials, and blog posts
        - **Word Count**: Select from 300 to 1500 words based on your needs
        - **Powered by Google Gemini**: High-quality AI text generation
        - **Seamless Integration**: Generated text flows directly into the rewriting and audio pipeline
        - **Perfect for**: Content creation, inspiration, educational material, and storytelling
        """)
